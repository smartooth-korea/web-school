                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function() {
                            var e, t, i = this,
                                ...
                                p = 1 / 0,
                                f = this._movePoint,
                                m = this.get("maxTooltipDistance"),
                                v = this.get("maxTooltipDistanceBy", "xy");
                            d.isNumber(m) && this.series.each((function(i) {
                                var a = i.get("tooltip");
                                if (a) {
                                    var r = a.get("pointTo");
                                    if (r) {
                                        var n = Math.hypot(f.x - r.x, f.y - r.y);
                                        "x" == v ? n = Math.abs(f.x - r.x) : "y" == v && (n = Math.abs(f.y - r.y)), n < p && (p = n, e = i, t = r)
                                    }
                                }
                            }));
                            var y = [];
                                    ...
                                    if (r) {
                                        ...
                                        if (o) {
                                            if (m >= 0) {
                                                var s = r.get("pointTo");
                                                if (s && a != e) {
                                                    var l = Math.hypot(t.x - s.x, t.y - s.y);
                                                    "x" == v ? l = Math.abs(t.x - s.x) : "y" == v && (l = Math.abs(t.y - s.y)), l > m && (n = !0)
                                                }
                                            } else - 1 == m && a != e && (n = !0);
                                            i.inPlot(i._tooltipToLocal(o)) && r.dataItem ? n || (c += o.y) : n = !0, n || a.isHidden() || a.isHiding() ? r.hide(0) : (r.show(), h.push(r), y.push(a))
                                        }
                                    }
                                })), this.setPrivate("tooltipSeries", y), this.get("arrangeTooltips")) {
                                var _ = this._root.tooltipContainer,
                                    x = h.length;
                                if (c / x > n / 2 + s.y) {
                                    h.sort((function(e, t) {
                                    ...
                                    if (b.each(h, (function(e) {
                                            ...
                                            i instanceof u.gG && (t *= i.value), t += e.get("marginBottom", 0), e.set("bounds", {
                                                ...
                                                right: l.x,
                                                bottom: w
                                            }), e.setPrivate("customData", {
                                                left: s.x,
                                                top: s.y,
                                                right: l.x,
                                                bottom: w
                                            }), w = Math.min(w - t, e._fy - t), e.parent == _ && _.children.moveValue(e, 0)
                                        })), w < 0) {
                                        h.reverse();
                                        var P = w;
                                        b.each(h, (function(e) {
                                            ...
                                            if (t) {
                                                var i = t.top - w,
                                                    a = t.bottom - w;
                                                i < P && (a = (i = P) + e.height()), e.set("bounds", {
                                                    left: t.left,
                                                    top: i,
                                                    right: t.right,
                                                    bottom: a
                                                }), P = t.bottom - w + e.get("marginBottom", 0)
                                            }
                                        }))
                                    }
                                } else {
                                    h.reverse(), h.sort((function(e, t) {
                                    ...
                                    if (b.each(h, (function(e) {
                                            ...
                                            i instanceof u.gG && (t *= i.value), t += e.get("marginBottom", 0), e.set("bounds", {
                                                ...
                                                top: O,
                                                right: l.x,
                                                bottom: Math.max(s.y + o, O + t)
                                            }), e.parent == _ && _.children.moveValue(e, 0), O = Math.max(O + t, e._fy + t)
                                        })), O > o) {
                                        h.reverse();
                                        var T = o;
                                        b.each(h, (function(e) {
                                            ...
                                            if (t) {
                                                var i = t.top - (o - O),
                                                    a = t.bottom - (o - O);
                                                a > T && (i = (a = T) - e.height()), e.set("bounds", {
                                                    left: t.left,
                                                    top: i,
                                                    right: t.right,
                                                    bottom: a
                                                }), T = a - e.height() - e.get("marginBottom", 0)
                                            }
                                        }))
                                    }
                                }
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "setupDefaultRules", {
                        ...
                        value: function() {
                            ...
                            r("XYChart").setAll({
                                ...
                                strokeOpacity: .8,
                                strokeDasharray: [2, 2],
                                ariaLabel: a.translate("Use left and right arrows to move selection")
                            }), (0, s.v)(m, "stroke", i, "alternativeBackground"), (m = r("Grid", ["cursor", "y"])).setAll({
                                strokeOpacity: .8,
                                strokeDasharray: [2, 2],
                                ariaLabel: a.translate("Use up and down arrows to move selection")
                            ...
                            (0, s.v)(m, "stroke", i, "disabled"), r("Graphics", ["line", "series", "legend", "marker", "fill"]).setAll({
                                ...
                                valueXGrouped: "close",
                                valueYGrouped: "close"
                            }), m = r("Rectangle", ["column", "autocolor"]).states.create("riseFromOpen", {}), (0, s.v)(m, "fill", i, "positive"), (0, s.v)(m, "stroke", i, "positive"), m = r("Rectangle", ["column", "autocolor"]).states.create("dropFromOpen", {}), (0, s.v)(m, "fill", i, "negative"), (0, s.v)(m, "stroke", i, "negative"), r("Rectangle", ["column", "autocolor", "pro"]).states.create("riseFromOpen", {
                                fillOpacity: 0
                            }), r("Rectangle", ["column", "autocolor", "pro"]).states.create("dropFromOpen", {
                                fillOpacity: 1
                            }), m = r("Rectangle", ["column", "autocolor", "pro"]).states.create("riseFromPrevious", {}), (0, s.v)(m, "fill", i, "positive"), (0, s.v)(m, "stroke", i, "positive"), m = r("Rectangle", ["column", "autocolor", "pro"]).states.create("dropFromPrevious", {}), (0, s.v)(m, "fill", i, "negative"), (0, s.v)(m, "stroke", i, "negative")
                        }
                    }), t
                }(r.Q)
        },
        3355: function(e, t, i) {
            ...
            var a = i(5125),
                ...
                b = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function() {
                            ...
                            this._settings.themeTags = u.mergeTags(this._settings.themeTags, ["xy", "cursor"]), e.prototype._afterNew.call(this), this.setAll({
                                ...
                                t._handleYLine()
                            })), this.lineX.events.on("focus", (function(e) {
                                return t._handleLineFocus(e.target)
                            })), this.lineX.events.on("blur", (function(e) {
                                return t._handleLineBlur(e.target)
                            })), this.lineY.events.on("focus", (function(e) {
                                return t._handleLineFocus(e.target)
                            })), this.lineY.events.on("blur", (function(e) {
                                return t._handleLineBlur(e.target)
                            })), u.supports("keyboardevents") && this._disposers.push(u.addEventListener(document, "keydown", (function(e) {
                                t._handleLineMove(e.keyCode)
                            })))
                        }
                    }), Object.defineProperty(t.prototype, "_setUpTouch", {
                        enumerable: !1,
                    ...
                    }), Object.defineProperty(t.prototype, "_handleLineMove", {
                        enumerable: !1,
                        configurable: !0,
                        writable: !0,
                        value: function(e) {
                            var t = "",
                                ...
                                a = .1,
                                r = this.chart;
                            this._root.focused(this.lineX) ? (r && r.xAxes.length && (a = r.xAxes.getIndex(0).getCellWidthPosition()), i = this.getPrivate("positionX", 0), t = "positionX", 37 == e ? i -= a : 39 == e && (i += a)) : this._root.focused(this.lineY) && (r && r.yAxes.length && (a = r.yAxes.getIndex(0).getCellWidthPosition()), i = this.getPrivate("positionY", 0), t = "positionY", 38 == e ? i -= a : 40 == e && (i += a)), i < 0 ? i = 0 : i > 1 && (i = 1), "" != t && this.set(t, i)
                        }
                    }), Object.defineProperty(t.prototype, "_handleLineFocus", {
                        enumerable: !1,
                        configurable: !0,
                        writable: !0,
                        value: function(e) {
                    ...
                    }), Object.defineProperty(t.prototype, "_handleLineBlur", {
                        enumerable: !1,
                        configurable: !0,
                        writable: !0,
                        value: function(e) {
            ...
            var a = i(5125),
                ...
                p = function(e) {
                    function t() {
                        ...
                        }), Object.defineProperty(t, "_bullets", {
                            enumerable: !0,
                            configurable: !0,
                            writable: !0,
                            value: {}
                        }), Object.defineProperty(t, "_crispX", {
                            enumerable: !0,
                            configurable: !0,
                            writable: !0,
                            value: 0
                        }), Object.defineProperty(t, "_crispY", {
                            enumerable: !0,
                            configurable: !0,
                            writable: !0,
                            value: 0
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_dispose", {
                        ...
                        value: function() {
                            ...
                            h.isNumber(i) && (u.each(this.series, (function(a) {
                                if (a.get("baseAxis") === e) {
                                    var r = e.getSeriesItem(a, i, e.get("tooltipLocation"));
                        ...
                        writable: !0,
                        value: function(e) {}
                    }), Object.defineProperty(t.prototype, "getCellWidthPosition", {
                        enumerable: !1,
                        configurable: !0,
                        writable: !0,
                        value: function() {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function(e, t, i, a) {
                            if (e) {
                                o.isNumber(t) || (t = 0);
                                var r = .5;
                                r = o.isNumber(a) && a > 1 ? e.get("multiLocation", r) : e.get("location", r), o.isNumber(i) && i != t && (t += (i - t) * r), e.set("x", Math.round(this.positionToCoordinate(t) - this.axis._crispX + .5));
                        ...
                        value: function(e, t, i) {
                            if (e) {
                                ...
                                o.isNumber(i) && i != t && (t += (i - t) * a), e.set("x", Math.round(this.positionToCoordinate(t) - this.axis._crispX + .5)), this.toggleVisibility(e, t, 0, 1)
                            }
                        }
                        ...
                        value: function(e, t, i) {
                            if (e) {
                                ...
                                if (a) {
                                    ...
                                    var n = this.axis.roundAxisPosition(t, r),
                                        s = this.axis._bullets[n],
                                        l = -1;
                                    if (this.get("opposite") && (l = 1), e.get("stacked"))
                                        if (s) {
                                            var u = s.get("sprite");
                                            u && a.set("y", u.y() + u.height() * l)
                                        } else a.set("y", 0);
                                    this.axis._bullets[n] = e, a.set("x", this.positionToCoordinate(t)), this.toggleVisibility(a, t, 0, 1)
                                }
                            }
                        }
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function(e, t, i) {
                            if (e) {
                                o.isNumber(t) || (t = 0);
                                var a = e.get("location", .5);
                                o.isNumber(i) && i != t && (t += (i - t) * a), e.set("y", Math.round(this.positionToCoordinate(t)) - this.axis._crispY + .5), this.toggleVisibility(e, t, 0, 1)
                            }
                        }
                    }), Object.defineProperty(t.prototype, "updateTick", {
                        enumerable: !1,
                        ...
                        value: function(e, t, i, a) {
                            if (e) {
                                o.isNumber(t) || (t = 0);
                                var r = .5;
                                r = o.isNumber(a) && a > 1 ? e.get("multiLocation", r) : e.get("location", r), o.isNumber(i) && i != t && (t += (i - t) * r), e.set("y", Math.round(this.positionToCoordinate(t)) - this.axis._crispY + .5);
                            ...
                            if (e) {
                                ...
                                if (a) {
                                    ...
                                    if (this.get("opposite") && (l = -1), e.get("stacked"))
                                        if (s) {
                                            var u = s.get("sprite");
                                            u && a.set("x", u.x() + u.width() * l)
                                        } else a.set("x", 0);
                                    this.axis._bullets[n] = e, a.set("y", this.positionToCoordinate(t)), this.toggleVisibility(a, t, 0, 1)
                                }
                            }
                        }
                    }), Object.defineProperty(t.prototype, "updateFill", {
        ...
        5638: function(e, t, i) {
            ...
            var a = i(5125),
                ...
                p = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function(e) {
                            if (this.get("groupData") && !e.get("groupDataDisabled")) {
                                ...
                                var n, s = this.getPrivate("name") + this.get("renderer").getPrivate("letter"),
                                    h = e.get("baseAxis");
                                e.get("xAxis") === h ? n = e._valueYFields : e.get("yAxis") === h && (n = e._valueXFields);
                                var p = e._mainDataItems,
                                    b = this.get("baseInterval"),
                                    d = b.timeUnit + b.count;
                                e._dataSets[d] = p;
                                var g = e.get("groupDataCallback"),
                                    f = e.get("groupDataWithOriginals", !1);
                                g && (f = !0);
                                var m = this._root.locale.firstDayOfWeek,
                                    v = this._root.utc,
                                    y = this._root.timezone;
                                l.each(t, (function(t) {
                                    var i, a = -1 / 0,
                                        h = t.timeUnit + t.count;
                                    e._dataSets[h] = [];
                                    var b = {},
                                        d = {},
                                        _ = {},
                                        x = {};
                                    l.each(n, (function(t) {
                                        b[t] = 0, d[t] = 0, _[t] = e.get(t + "Grouped"), x[t] = t + "Working"
                                    }));
                                    var w, P, O = c.getDuration(t.timeUnit);
                                    p[0] && (w = new Date(p[0].get(s))), l.each(p, (function(p) {
                                        var T, D = p.get(s),
                                            j = c.round(new Date(D), t.timeUnit, t.count, m, v, w, y).getTime();
                                        a < j - O / 24 ? (T = u.copy(p.dataContext), (i = new r.z(e, T, e._makeDataItem(T))).setRaw(s, j), e._dataSets[h].push(i), l.each(n, (function(e) {
                                            var t = p.get(e);
                                            o.isNumber(t) ? (i.setRaw(e, t), i.setRaw(x[e], t), d[e] = 1, b[e] = t) : (b[e] = 0, d[e] = 0)
                                        })), f && i.set("originals", [p]), g && P && g(P, t), P = i) : (l.each(n, (function(e) {
                                            var t = _[e],
                                                a = p.get(e);
                                            if (void 0 !== a) {
                                                var r = i.get(e);
                                                switch (t) {
                                                    ...
                                                    case "average":
                                                        ...
                                                        break;
                                                    case "extreme":
                                                        Math.abs(a) > Math.abs(r) && i.setRaw(e, a)
                                                }
                                                i.setRaw(x[e], i.get(e));
                                                var o = u.copy(p.dataContext);
                                                o[s] = j, i.dataContext = o
                                            }
                                        })), f && i.get("originals").push(p)), a = j
                                    })), g && P && g(P, t)
                        ...
                        value: function() {
                            ...
                            var i = Math.round(this.getPrivate("selectionMin")),
                                a = Math.round(this.getPrivate("selectionMax"));
                            if (o.isNumber(i) && o.isNumber(a)) {
                                if (0 == this.get("endLocation") && (a += 1), this.get("groupData") && !this._groupingCalculated) {
                                    ...
                                    if (n && (!u || u.timeUnit !== n.timeUnit || u.count !== n.count || this._seriesDataGrouped)) {
                                        this._seriesDataGrouped = !1, this.setPrivateRaw("groupInterval", n), this._setBaseInterval(n);
                                        var h = n.timeUnit + n.count;
                                        l.each(this.series, (function(e) {
                                            e.get("baseAxis") === t && e.setDataSet(h)
                                        })), this.markDirtyExtremes(), this._root.events.once("frameended", (function() {
                                            t._root.events.once("frameended", (function() {
                                                var e = "groupintervalchanged";
                                                t.events.isEnabled(e) && t.events.dispatch(e, {
                                                    type: e,
                                                    target: t
                                                })
                                            }))
                                ...
                                l.each(this.series, (function(e) {
                                    if (e.get("baseAxis") === t) {
                                        ...
                                        n > 0 && (n -= 1), a += t.baseDuration() * (1 - t.get("endLocation", 1));
                    ...
                    }), Object.defineProperty(t.prototype, "_getM", {
                        enumerable: !1,
                        configurable: !0,
                        writable: !0,
                        value: function(e) {
                            return "month" == e || "year" == e ? 1.05 : 1.01
                        }
                        ...
                        value: function() {
                            ...
                            if (o.isNumber(e) && o.isNumber(t)) {
                                var i = Math.round(this.getPrivate("selectionMin")),
                                    n = Math.round(this.getPrivate("selectionMax")),
                                    s = this.get("renderer"),
                                ...
                                var f = c.getNextUnit(d.timeUnit),
                                    m = this._root.locale.firstDayOfWeek,
                                    v = this._root.utc,
                                    y = this._root.timezone,
                                    _ = (h = c.round(new Date(i - g), d.timeUnit, d.count, m, v, new Date(e), y).getTime()) - g,
                                    x = void 0,
                                    w = this.get("dateFormats");
                                for (this.setPrivateRaw("gridInterval", d); h < n + g;) {
                                    var P = void 0;
                                    this.dataItems.length < p + 1 ? (P = new r.z(this, void 0, {}), this._dataItems.push(P), this.processDataItem(P)) : P = this.dataItems[p], this._createAssets(P, []), P.isHidden() && P.show(), P.setRaw("value", h);
                                    var O = h + c.getDuration(d.timeUnit, d.count * this._getM(d.timeUnit));
                                    O = c.round(new Date(O), d.timeUnit, 1, m, v, void 0, y).getTime(), P.setRaw("endValue", O);
                                    var T = new Date(h);
                                    x = w[d.timeUnit], f && this.get("markUnitChange") && o.isNumber(_) && "year" != d.timeUnit && c.checkChange(h, _, f, v, y) && (x = this.get("periodChangeDateFormats")[d.timeUnit]);
                                    var D = P.get("label");
                                    if (D && D.set("text", this._root.dateFormatter.format(T, x)), this._prepareDataItem(P, d.count), _ = h, (h = O) == _) break;
                                    p++
                                }
                                for (var j = p; j < this.dataItems.length; j++) this.dataItems[j].hide();
                                l.each(this.series, (function(e) {
                        ...
                        value: function(e) {
                            var t = this.getPrivate("baseInterval"),
                                ...
                                a = this._root.timezone,
                                r = this._root.utc,
                                n = t.timeUnit,
                                o = c.round(new Date(e), n, t.count, i, r, void 0, a).getTime(),
                                s = o + c.getDuration(n, t.count * this._getM(n));
                            return o + ((s = c.round(new Date(s), n, 1, i, r, void 0, a).getTime()) - o) * this.get("startLocation", 0)
                        }
                        ...
                        value: function(e) {
                            var t = this.getPrivate("baseInterval"),
                                ...
                                o = c.round(new Date(e), n, t.count, i, r, void 0, a).getTime(),
                                s = o + c.getDuration(n, t.count * this._getM(n));
                            return o + ((s = c.round(new Date(s), n, 1, i, r, void 0, a).getTime()) - o) * this.get("endLocation", 1)
                        }
                            ...
                            e.open || (e.open = {}), e.close || (e.close = {}), l.each(t, (function(t) {
                                ...
                                if (o.isNumber(r)) {
                                    ...
                                    if (r >= n && r <= s);
                                        ...
                                        var l = i._root.locale.firstDayOfWeek,
                                            u = i._root.utc,
                                            h = i._root.timezone,
                                            p = a.timeUnit,
                                            b = a.count;
                                        s = (n = c.round(new Date(r), p, b, l, u, void 0, h).getTime()) + c.getDuration(p, b * i._getM(p)), s = c.round(new Date(s), p, 1, l, u, void 0, h).getTime(), e.open[t] = n, e.close[t] = s
                                    }
                                    i._updateDates(n)
                                }
                            }))
                        ...
                        value: function(e, t) {
                            ...
                            var a = this.getPrivate("baseInterval");
                            if (!o.isNaN(i)) {
                                var r = this._root.locale.firstDayOfWeek,
                                    n = a.timeUnit,
                                    s = this._root.utc,
                                    l = this._root.timezone,
                                    u = a.count;
                                i = c.round(new Date(i), n, u, r, s, new Date(this.getPrivate("min", 0)), l).getTime();
                                var h = c.getDateIntervalDuration(a, new Date(i), r, s, l);
                                return l && (i = c.round(new Date(i + .05 * this.baseDuration()), n, u, r, s, new Date(this.getPrivate("min", 0)), l).getTime(), h = c.getDateIntervalDuration(a, new Date(i + h * t), r, s, l)), this.valueToPosition(i + h * t)
                            }
                            return NaN
                        }
                        ...
                        value: function(e) {
                            if (null != this.getPrivate("min")) {
                                var t = this.get("tooltipDateFormats")[this.getPrivate("baseInterval").timeUnit],
                                    ...
                                    n = c.getDateIntervalDuration(r, a, this._root.locale.firstDayOfWeek, this._root.utc, this._root.timezone);
                                return this._root.dateFormatter.format(new Date(i + this.get("tooltipIntervalOffset", -this.get("tooltipLocation", .5)) * n), this.get("tooltipDateFormat", t))
                            }
                            return ""
                        }
                        ...
                        value: function(e, t, i) {
                            ...
                            null == i && (i = .5), r -= (i - .5) * this.baseDuration();
                            var n = l.getSortedIndex(e.dataItems, (function(e) {
                                var t = 0;
                                return e.open && (t = e.open[a]), s.qu(t, r)
                            }));
                            if (e.get("snapTooltip")) {
                                var o = e.dataItems[n.index - 1],
                                    u = e.dataItems[n.index];
                                if (o && u && o.open && u.close) {
                                    var h = o.open[a],
                                        c = u.close[a];
                                    if (Math.abs(r - h) > Math.abs(r - c)) return u
                                }
                                if (o) return o;
                                if (u) return u
                            } else {
                                var p = e.dataItems[n.index - 1];
                                if (p && p.open && p.close) {
                                    var b = p.open[a],
                                        d = p.close[a];
                                    if (r >= b && r <= d) return p
                        ...
                        writable: !0,
                        value: function() {
                            var e = this.getPrivate("selectionMax", this.getPrivate("max")),
                                t = this.getPrivate("selectionMin", this.getPrivate("min"));
                            return o.isNumber(e) && o.isNumber(t) ? this.baseDuration() / (e - t) : .05
                        }
                    }), Object.defineProperty(t, "className", {
                        enumerable: !0,
                        configurable: !0,
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function(e) {
                            var t = this._dates,
                                ...
                                a = this.get("endLocation", 1),
                                r = t.length - i - (1 - a),
                                n = o.getSortedIndex(t, (function(t) {
                                    return s.qu(t, e)
                                })),
                                l = n.index;
                            if (n.found) return (l - i) / r;
                            l > 0 && (l -= 1);
                            var u = t[l];
                            return (l - i) / r + (u > e ? u - e : e - u) / this.baseDuration() / r
                        }
                        ...
                        writable: !0,
                        value: function(e) {
                            var t = this.get("startLocation", 0),
                                i = this.get("endLocation", 1),
                                a = Math.round(this._dates.length - t - (1 - i)),
                                r = e * a,
                                n = Math.floor(r);
                            return n < 0 && (n = 0), n > a - 1 && (n = a - 1), this._dates[n] + (r - n + t) * this.baseDuration()
                        }
                    }), Object.defineProperty(t.prototype, "_fixZoomFactor", {
                        enumerable: !1,
                        configurable: !0,
                        ...
                        value: function() {
                            ...
                            if (u.isNumber(t) && u.isNumber(i)) {
                                ...
                                for (var O = l.round(new Date(this.getPrivate("min", 0)), v.timeUnit, v.count, this._root.locale.firstDayOfWeek, this._root.utc, P, this._root.timezone), T = l.add(O, v.timeUnit, -1, this._root.utc, this._root.timezone).getTime(), D = this.getPrivate("selectionMax"), j = -1 / 0, A = (this.get("end", 1) - this.get("start", 0)) / b; T <= D;) {
                                    ...
                                    Y - j >= .95 * A && (o.move(w, k), j = Y);
                                    var X = T;
                                    if (T += l.getDuration(v.timeUnit, v.count * this._getM(v.timeUnit)), (T = l.round(new Date(T), v.timeUnit, v.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime()) == X) break
                                }
                                if (w.length > 0) {
                                    var S = 0,
                                        F = T - 10 * _,
                                        N = l.getNextUnit(v.timeUnit);
                                    o.each(w, (function(t) {
                                        var i;
                                        ...
                                        if (S < w.length - 1 ? s = r[w[S + 1]] : s += _, i.setRaw("value", a), i.setRaw("endValue", s), i.setRaw("index", S), t > c - 100 && t < p + 100) {
                                            var h = x[v.timeUnit];
                                            h = x[v.timeUnit], N && e.get("markUnitChange") && u.isNumber(F) && "year" != v.timeUnit && l.checkChange(a, F, N, e._root.utc, e._root.timezone) && (h = e.get("periodChangeDateFormats")[v.timeUnit]), e._createAssets(i, []);
                                            var b = i.get("label");
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "markDirtyExtremes", {
                        ...
                        value: function() {
                            ...
                            if (s.isNumber(i) && s.isNumber(r)) {
                                ...
                                var w = Math.min(20, Math.ceil(Math.log(this.getPrivate("maxZoomFactor", 100) + 1) / Math.LN10) + 2),
                                    P = u.round(this.valueToFinalPosition(g), w),
                                    O = u.round(this.valueToFinalPosition(f), w);
                                this.setPrivateRaw("selectionMinFinal", g), this.setPrivateRaw("selectionMaxFinal", f), this.setPrivateRaw("selectionStepFinal", _.step), this.zoom(P, O)
                            }
                        }
                        ...
                        value: function() {
                            ...
                            if (l.each(this.series, (function(t) {
                                ...
                                var c = this.get("treatZeroAs");
                                s.isNumber(c) && a <= 0 && (a = c), a <= 0 && new Error("Logarithmic value axis can not have values <= 0.")
                            }
                            if (0 === a && 0 === r && (r = .9, a = -.9), s.isNumber(t) && (a = t), s.isNumber(i) && (r = i), a !== 1 / 0 && r !== -1 / 0) {
                                var p = a,
                                    b = r,
                                    d = this.adapters.fold("min", a),
                                    g = this.adapters.fold("max", r);
                                s.isNumber(d) && (a = d), s.isNumber(g) && (r = g), a = this._fixMin(a), (r = this._fixMax(r)) - a <= 1 / Math.pow(10, 15) && (r - a != 0 ? this._deltaMinMax = (r - a) / 2 : this._getDelta(r), a -= this._deltaMinMax, r += this._deltaMinMax), r += (r - (a -= (r - a) * n)) * o, this.get("logarithmic") && (a < 0 && p >= 0 && (a = 0), r > 0 && b <= 0 && (r = 0)), this._minReal = a, this._maxReal = r;
                                var f = this.get("strictMinMax"),
                                    m = this.get("strictMinMaxSelection", !1);
                                m && (f = m);
                                var v = f;
                                s.isNumber(i) && (v = !0);
                                var y = this.get("renderer").gridCount(),
                                    _ = this._adjustMinMax(a, r, y, v);
                                a = _.min, r = _.max, _ = this._adjustMinMax(a, r, y, !0), a = _.min, r = _.max, f && (a = s.isNumber(t) ? t : this._minReal, (r = s.isNumber(i) ? i : this._maxReal) - a <= 1e-8 && (a -= this._deltaMinMax, r += this._deltaMinMax), r += (r - (a -= (r - a) * n)) * o), d = this.adapters.fold("min", a), g = this.adapters.fold("max", r), s.isNumber(d) && (a = d), s.isNumber(g) && (r = g), h == 1 / 0 && (h = r - a);
                                var x = Math.round(Math.abs(Math.log(Math.abs(r - a)) * Math.LOG10E)) + 5;
                                a = u.round(a, x), r = u.round(r, x);
                                var w = this.get("syncWithAxis");
                                if (w && (_ = this._syncAxes(a, r, _.step, w.getPrivate("minFinal", w.getPrivate("min", 0)), w.getPrivate("maxFinal", w.getPrivate("max", 1)), w.getPrivate("step", 1)), a = _.min, r = _.max), this.setPrivateRaw("maxZoomFactor", Math.max(1, Math.ceil((r - a) / h * this.get("maxZoomFactor", 100)))), this._fixZoomFactor(), this.get("logarithmic") && (this._minLogAdjusted = a, a = this._minReal, r = this._maxReal, a <= 0 && (a = p * (1 - Math.min(n, .99)))), s.isNumber(a) && s.isNumber(r) && (this.getPrivate("minFinal") !== a || this.getPrivate("maxFinal") !== r)) {
                ...
                u = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_makeGraphics", {
                        ...
                        value: function() {
                            ...
                            this.updateLegendMarker(this.get("tooltipDataItem")), e.prototype._updateChildren.call(this)
                        }
                        ...
                        value: function(e, t) {
                            ...
                            if (null != u && null != h) {
                                ...
                                if (T.isType("CategoryAxis") && O.isType("CategoryAxis")) {
                                    ...
                                    x instanceof n.gG && (S += L = (F - S) * (1 - x.value) / 2, F -= L), c = O.getDataItemPositionX(e, g, S, C), p = O.getDataItemPositionX(e, r, F, C), S = this._aLocationY0 + _ - .5, F = this._aLocationY1 + v - .5, w instanceof n.gG && (S += L = (F - S) * (1 - w.value) / 2, F -= L), b = T.getDataItemPositionY(e, f, S, M), d = T.getDataItemPositionY(e, o, F, M), e.setRaw("point", {
                                        x: c + (p - c) / 2,
                                        y: b + (d - b) / 2
                                    })
                                } else if (O === D) {
                                    if (S = this._aLocationX0 + y - .5, F = this._aLocationX1 + m - .5, x instanceof n.gG && (S += L = (F - S) * (1 - x.value) / 2, F -= L), c = O.getDataItemPositionX(e, g, S, C), p = O.getDataItemPositionX(e, r, F, C), b = T.getDataItemPositionY(e, o, v, M), this._yOpenField !== this._yField) d = T.getDataItemPositionY(e, f, _, M);
                                    else if (P) {
                                    ...
                                    var L;
                                    if (S = this._aLocationY0 + _ - .5, F = this._aLocationY1 + v - .5, w instanceof n.gG && (S += L = (F - S) * (1 - w.value) / 2, F -= L), b = T.getDataItemPositionY(e, f, S, M), d = T.getDataItemPositionY(e, o, F, M), p = O.getDataItemPositionX(e, r, m, C), this._xOpenField !== this._xField) c = O.getDataItemPositionX(e, g, y, C);
                                    else if (P) {
                                        var R = e.get("stackToItemX");
                                        c = R ? O.getDataItemPositionX(R, r, y, R.component.get("vcx")) : O.basePosition()
                        ...
                        value: function(e) {
                            ...
                            for (k = e; k < a; k++) {
                                ...
                                var V = this._dataItems[k],
                                    G = V.get(m),
                                    E = V.get(v);
                                if (null == G || null == E ? n || (A = [], j.push(A), R.points = A) : this._getPoints(V, R), I) {
                                ...
                                if (!n) {
                                    ...
                                    W && d.shouldGap(V, W, r, P) && (A = [], j.push(A), R.points = A)
                                }
                            }
            ...
            var a = i(5125),
                ...
                b = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                                        ...
                                        case 0:
                                            return r = [e.prototype.hideDataItem.call(this, t, i)], n = this.states.create("hidden", {}), u.isNumber(i) || (i = n.get("stateAnimationDuration", this.get("stateAnimationDuration", 0))), o = n.get("stateAnimationEasing", this.get("stateAnimationEasing")), s = this.get("xAxis"), l = this.get("yAxis"), h = this.get("baseAxis"), p = this.get("stacked"), h !== s && h || c.each(this._valueYFields, (function(e) {
                                                var a = l.getPrivate("min"),
                                                    n = l.baseValue();
                                                u.isNumber(a) && a > n && (n = a), p && (n = 0), null != t.get(e) && r.push(t.animate({
                                                    key: e + "Working",
                                                    to: n,
                                                    duration: i,
                                                    easing: o
                        ...
                        value: function() {
                            var t = this.get("tooltip");
                            return t && t.set("tooltipTarget", this), e.prototype.hideTooltip.call(this)
                        }
                    }), Object.defineProperty(t.prototype, "_getTooltipTarget", {
                        enumerable: !1,
                        configurable: !0,
                ...
                w = function(e) {
                    ...
                    return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function(t, i, a, n) {
                            ...
                            return this.setPrivateRaw("durationFormat", u.getFormat(l.step, l.max, h)), l
                        }
                    }), Object.defineProperty(t.prototype, "_formatText", {
                        enumerable: !1,
                        configurable: !0,
