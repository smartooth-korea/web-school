...
<!--  <sup>2</sup> -->
    ...
    <li class="nav-item active">
        <a class="nav-link" href='/web/user/main.do' ">
...
<!--     </li> -->
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="/web/product/selectProductMain.do"">조회</a>
                <a class="collapse-item" href="/web/product/selectProductMain.do"">입고/출고</a>
