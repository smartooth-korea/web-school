...
<link rel="stylesheet" href="/css/web/statistics/diagnosis_main_en.css">
</head>
<body>
			...
			<div class="temp1" style="width: 22px;">
				...
				<div class="contents-bottom-div">
					<div class="contents-bottom">
						<div>*Please use these results as a guide, and we recommend a visit to your dentist for an accurate diagnosis.</div>
					</div>
				</div>
			</div>
		</div>
